...
import type { PostItem } from "@/types/contentful";
...
const WritingLink = ({ post, viewCount, isMobile }: WritingLinkProps) => {
        ...
        >
          ...
          <span>
            {formattedViewCount ? (
              ...
              >
                &middot; {formattedViewCount}{" "}
                {formattedViewCount === "1" ? "view" : "views"}
              </m.span>
            ) : (
